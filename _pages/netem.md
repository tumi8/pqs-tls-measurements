---
layout: page
permalink: /reproducibility/netem/
title: "Table 4"
description: "Median handshakes latency measured for different network scenarios. Loss, RTT, and bandwidth were emulated with netem. The width of the bars are scaled depending on the Maximum latency per table and scenario."
---

<h3>Full Tables</h3>
<figure style="display:block;margin-left:auto;margin-right:auto;width:100%;float:left;">
<img style="width:100%;" src="{{ site.baseurl }}/figures/table-netem-kem.pdf.svg">
<figcaption style="text-align:center;">KAs combined with rsa:2048 as SA</figcaption>
</figure>
<figure style="display:block;margin-left:auto;margin-right:auto;width:100%;float:left;">
<img style="width:100%;" src="{{ site.baseurl }}/figures/table-netem-sig.pdf.svg">
<figcaption style="text-align:center;">SAs combined with X25519 as KA</figcaption>
</figure>
...
<details>
<summary>Loop variables for all KAs</summary>
{% include loop_vars_kem_netem.html %}
</details>
<details>
...
```bash
./experiment.py --output-dir /opt/experiments all-kem-scenarios all-sig-scenarios
```
...
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Client results under all-kem-scenarios/client</a>: Contains the outputs of the scripts executed on the client for netem-based scenario.</li>
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Server results under all-kem-scenarios/server</a>: Contains the outputs of the scripts executed on the server for netem-based scenario.</li>
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Timestamper results under all-kem-scenarios/timestamper</a>: Contains the PCAPs of the experiment from netem-based scenario.</li>
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Client results under all-sig-scenarios/client</a>: Contains the outputs of the scripts executed on the client for netem-based scenario.</li>
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Server results under all-sig-scenarios/server</a>: Contains the outputs of the scripts executed on the server for netem-based scenario.</li>
<li><a href="https://dataserv.ub.tum.de/index.php/s/m1725057">Timestamper results under all-sig-scenarios/timestamper</a>: Contains the PCAPs of the experiment from netem-based scenario.</li>
