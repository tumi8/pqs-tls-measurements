---
layout: page
permalink: /reproducibility/sig/
title: "Table 2b"
description: "Handshake latency, and data usage. SIGs combined with X25519 as KEM."
---


<h3>Full Table</h3>
<p><img src="{{ site.baseurl }}/figures/sig/table-sig.pdf.svg" alt="Table 2b in full length." style="display:block;margin-left:auto;margin-right:auto;width=90%;"></p>
...
<p>The following loop variable file contains all SIGs and one KEM for the experiment</p>
<details>
...
```bash
./experiment.py --output-dir /opt/experiments all-sig
``` 
